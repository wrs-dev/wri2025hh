...
const navigation = {
  ...
  support: [
    ...
    { name: 'Info Zone/Expo Zone', href: 'https://wri2025hh.wheel-rail-seminars.com/sponsor-packages', target: '_self' },
    { name: 'Become a Sponsor', href: 'https://wri2025hh.wheel-rail-seminars.com/sponsor-packages', target: '_self' },
  ],
  company: [
    { name: 'Register Now', href: 'https://wri2025hh.wheel-rail-seminars.com/register', target: '_blank' },
    { name: 'Seminar Pricing Packages', href: 'https://wri2025hh.wheel-rail-seminars.com/#register', target: '_self' },
    { name: 'Hotel Reservations', href: 'https://wri2025hh.wheel-rail-seminars.com/#hotel', target: '_self' },
